...
module body_bias_ctrl (
    ...
    typedef enum reg [2:0] {
        ...
        ADJUST = 3'b010,
        VERIFY = 3'b011,
        CALIBRATE_COMPLETE = 3'b100
    } cal_state_t;

    cal_state_t cal_state, next_cal_state;
            ...
            case (cal_state)
                    ...
                    if (measure_en) begin
                        ...
                        if (measurement_timer > 32'd1000) begin
                            ...
                            if (bias_code_reg < 8'hFF) begin
                                ...
                                next_cal_state <= CALIBRATE_COMPLETE;
                            end
                        end
                        else begin
                            next_cal_state <= MEASURE;
                        ...
                        next_cal_state <= MEASURE;  // Wait for measurement to be enabled
                    end
                end
                ...
                ADJUST: begin
                    ...
                    if (bias_code_reg != target_bias_code) begin
                        ...
                        next_cal_state <= VERIFY;
                    end
                    next_cal_state <= VERIFY;  // Move to verification
                end
