...
module eml_constant_time (
    ...
    // State encoding for constant-time operation
    parameter ST_IDLE = 3'b000;
    parameter ST_EXECUTE = 3'b001;
    parameter ST_PAD = 3'b010;
    parameter ST_FINALIZE = 3'b011;
    parameter ST_STALL_BRANCH = 3'b100;
